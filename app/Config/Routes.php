...
// laporan penjualan
$routes->get('/laporan-penjualan','Laporan::datalaporanpenjualan');
//pdf
$routes->get('/pdf-penjualan', 'PdfController::laporanpenjualan');
$routes->get('/pdf-penjualan/generate-penjualan', 'PdfController::generatepenjualan');
