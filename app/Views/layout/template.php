...
<div id="right-sidebar" class="settings-panel">
  ...
  <ul class="nav">
    ...
    <?php if(session()->get('levelPengguna')=='admin') { ?>
    <li class="nav-item nav-category">MASTER DATA</li>
    <li class="nav-item">
      <a class="nav-link" data-bs-toggle="collapse" href="<?= site_url('list-pengguna');?>" aria-expanded="false"
      ...
      <div class="collapse" id="form-elements">
        <ul class="nav flex-column sub-menu">
          <li class="nav-item"><a class="nav-link" >Basic Elements</a></li>
        </ul>
      </div>
    </li>
    ...
    <li class="nav-item">
      <a class="nav-link" data-bs-toggle="collapse" href="<?= site_url('/data-kategori'); ?>" aria-expanded="false" aria-controls="icons">
    ...
    <li class="nav-item">
      <a class="nav-link" data-bs-toggle="collapse" href="<?= site_url('/data-satuan'); ?>" aria-expanded="false" aria-controls="icons">
        <i class="menu-icon mdi mdi-layers-outline"></i>
    ...
    <li class="nav-item">
      <a class="nav-link" data-bs-toggle="collapse" href="<?= site_url('data-produk'); ?>" aria-expanded="false" aria-controls="icons">
        <i class="menu-icon mdi mdi-layers-outline"></i>
    ...
    <li class="nav-item">
      <a class="nav-link" data-bs-toggle="collapse" href="<?= site_url('penjualan'); ?>" aria-expanded="false" aria-controls="auth">
    ...
    <li class="nav-item">
      <a class="nav-link" data-bs-toggle="collapse" href="<?= site_url('logout'); ?>" aria-expanded="false" aria-controls="icons">
        <i class="menu-icon mdi mdi-layers-outline"></i>
  ...
  <div class="d-sm-flex justify-content-center justify-content-sm-between">
    <span class="float-none float-sm-end d-block mt-1 mt-sm-0 text-center">Copyright by Aurdaan</span>
  </div>
</footer>
        <!-- partial -->
      </div>
  ...
  <!-- plugins:js -->
  <!-- <script src="<?=base_url('/StarAdmin/assets/vendors/js/vendor.bundle.base.js');?>"></script> -->
  <script src="<?=base_url('/StarAdmin/assets/vendors/bootstrap-datepicker/bootstrap-datepicker.min.js');?>"></script>
  <!-- endinject -->
  <!-- Plugin js for this page -->
  <script src="<?=base_url('/StarAdmin/assets/vendors/chart.js/Chart.min.js');?>"></script>
  <script src="<?=base_url('/StarAdmin/assets/vendors/progressbar.js/progressbar.min.js');?>"></script>
  <!-- End plugin js for this page -->
  <!-- inject:js -->
  <script src="<?=base_url('/StarAdmin/assets/js/off-canvas.');?>"></script>
  <script src="<?=base_url('/StarAdmin/assets/js/hoverable-collapse.js');?>"></script>
  <script src="<?=base_url('/StarAdmin/assets/js/template.js');?>"></script>
  <script src="<?=base_url('/StarAdmin/assets/js/settings.js');?>"></script>
  <script src="<?=base_url('/StarAdmin/assets/js/todolist.js');?>"></script>
  <script src="<?=base_url('/select2/js/select2.min.js');?>"></script>
  <!-- endinject -->
  <!-- Custom js for this page-->
  <script src="<?=base_url('/StarAdmin/assets/js/jquery.cookie.js" type="text/javascript');?>"></script>
  <script src="<?=base_url('/StarAdmin/assets/js/dashboard.js');?>"></script>
  <script src="<?=base_url('/StarAdmin/assets/js/proBanner.js');?>"></script>
  <script>
  $(document).ready(function(){
    $('.js-example-basic-basic').select2();
  });
  </script>
